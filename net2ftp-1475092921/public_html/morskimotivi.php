    ...
    <body>
	 <div id="omot">	
		  ...
		  <div class="nav">
		   ...
		   <?php 
		   include('konn.php');
		           $upit="SELECT * FROM galerija WHERE imeGal='morski'";
                   $rezultat=mysqli_query($conn,$upit) or die ("Nije dobar upit za galeriju morskih motiva".mysql_error()); 
