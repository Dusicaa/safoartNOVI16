  ...
  xmlhttp.send();
    ...
    <body>	
	 <div id="omot">
		   ...
		   <?php 
		   include('konn.php');
		           $upit="SELECT * FROM galerija WHERE imeGal='ikone'";
                   $rezultat=mysqli_query($conn,$upit) or die ("Nije dobar upit za galeriju ikona".mysql_error()); 
                                 
                   while($red=mysqli_fetch_array($rezultat)){
					   echo "<div class='galSlike'>";
					  echo "<img src='".$red['putanjaGal']."' class='uvecaj' alt='".$red['opisGal']."' />";
